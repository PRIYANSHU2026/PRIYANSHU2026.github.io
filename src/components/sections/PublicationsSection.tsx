...
const publications: Publication[] = [
  ...
  },
  {
   ...
   {
    id: 3,
    title: "Prediction of Traveling Ka Band Wave Tube Amplifier Characteristics Using FNN",
    conference: "2025 International Conference on Knowledge Engineering and Communication Systems (ICKECS)",
    year: 2025,
    link: "https://ieeexplore.ieee.org/document/11034912",
  },
  {
    id: 4,
    ...
    <section id="publications" className="py-16 sm:py-20 bg-gradient-to-b from-slate-900 to-slate-950">
      <div className="container mx-auto px-4 sm:px-6 max-w-7xl">
        <div className="text-center mb-10 sm:mb-16 relative">
          ...
          >
            Recent research publications in peer-reviewed journals and conferences
          </motion.p>
        </div>
