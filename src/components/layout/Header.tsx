...
const navigation = [
  ...
  { name: "Hackathon", href: "certificates" },
            ...
            <ScrollLink
              ...
              className={cn(
                ...
                activeSection === item.href
                  ? "text-blue-400 relative after:content-[''] after:absolute after:w-full after:h-0.5 after:bg-blue-400 after:left-0 after:-bottom-1"
                ...
                <div className="space-y-2 py-6">
                  {navigation.map((item) => (
                    <ScrollLink
                      ...
                      duration={500}
                      className={cn(
                        "block px-3 py-2 text-base font-medium cursor-pointer transition-colors duration-300",
                        activeSection === item.href
